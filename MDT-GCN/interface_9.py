...
class RealTimeEmotionRecognitionApp:
    def __init__(self, root, model, device):
        self.root = root
        self.root.title("Real time gait emotion recognition")
        ...
        self.start_button = ttk.Button(self.scrollable_frame, text="Start real-time detection", command=self.start_recognition)
        self.start_button.pack(pady=10)
        self.stop_button = ttk.Button(self.scrollable_frame, text="Stop detection", command=self.stop_recognition)
...
class EmotionRecognitionApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Gait emotion recognition")
        ...
        self.input_video_label = ttk.Label(main_frame, text="Input video", style="TLabel", background="white")
        self.input_video_label.grid(row=0, column=0, padx=10, pady=10)

        self.skeleton_video_label = ttk.Label(main_frame, text="Skeleton video", style="TLabel", background="white")
        self.skeleton_video_label.grid(row=0, column=1, padx=10, pady=10)

        self.select_button = ttk.Button(main_frame, text="Select video file", command=self.select_video)
